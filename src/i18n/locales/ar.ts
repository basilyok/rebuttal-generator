...
const ar = {
  ...
  // --- الاسترداد ---------------------------------------------------------------
  'recovery.title': 'رمز الاسترداد الخاص بك',
  'recovery.blurb':
    'هذا الرمز هو ما يعيدك إلى مفاتيح API وسجلّك المحفوظين إذا نسيت كلمة المرور. لن تراه إلا هذه المرة، فاحفظه في مكان ستجده لاحقًا — في مدير كلمات المرور أو على ورق.',
  'recovery.regenerateHint':
    'يمكنك إنشاء رمز جديد في أي وقت ما دمت مسجّل الدخول، لذا فقدان الرمز مجرد إزعاج وليس كارثة.',
  'recovery.copy': 'نسخ الرمز',
  'recovery.copied': 'تم النسخ',
  'recovery.warning':
    'إذا فقدت كلمة المرور وهذا الرمز معًا، فلن يمكن استرداد مفاتيح API وسجلّك المحفوظين — لا نحن ولا أي شخص آخر.',
  'recovery.confirm': 'لقد حفظت هذا الرمز في مكان آمن',
  'recovery.done': 'تم',
  'recovery.working': 'جارٍ الإعداد…',
  'recovery.setupFailed': 'تعذّر إعداد رمز الاسترداد الآن. حاول مرة أخرى، أو سجّل الدخول من جديد إذا استمر الأمر.',
  'recovery.promptBody':
    'ليس لديك رمز استرداد بعد. بدونه، نسيان كلمة المرور يعني فقدان مفاتيحك وسجلّك المحفوظين نهائيًا.',
  ...
  'recovery.statusStale': 'قد لا يعمل رمز الاسترداد · رمز جديد',
  'recovery.resetTitle': 'إعادة تعيين كلمة المرور',
  'recovery.resetIntro': 'أدخل اسم المستخدم ورمز الاسترداد الذي حفظته.',
  ...
  'recovery.resetInterrupted':
    'حدث ما قطع عملية إعادة التعيين. جرّب تسجيل الدخول بكلمة المرور الجديدة التي اخترتها للتو — فإن نجحت، فقد تمت إعادة التعيين. وإن لم تنجح، فكلمة مرورك القديمة ما زالت صالحة. وفي الحالتين، أنشئ بعدها رمز استرداد جديدًا.',
  ...
  'recovery.promptLostBody':
    'لديك رمز استرداد، لكن لم يتأكد على هذا الجهاز أنك حفظته: إذا ضاع قبل أن تدوّنه، فلن يعيد إليك حسابك. يمكنك استبداله برمز جديد الآن.',
  'recovery.promptLostAction': 'إنشاء رمز جديد',
  ...
  'reply.showingFull': 'يتم عرض الرسالة الكاملة',
